...
public class Calculadora {
    ...
    private boolean revisa(){
        PilaADT<Character> pila = new PilaE();
        boolean resp;
        int i, n;
    ...
    public static void main(String[] args) {
        ...
        String[] exp2 = new String[10];
        /*
        for(int i = 0; i < exp.length(); i++){
          exp2[i] = Character.toString(exp.charAt(i));
        }
          */
        exp2[0] = exp;
          System.out.println(conviertePostfija(exp2));
